...
const Votes = (props) => {
    return(
        <div className="votes__list">
            <div className={`votes__upvote votes__icon ${props.votes.uservotes.upvote ? 'active' : null}`} onClick={() => props.callback(true)}>
                ...
                {props.votes.upvotes.length}
            </div>
            <div className={`votes__downvote votes__icon ${!props.votes.uservotes.upvote ? 'active' : null}`} onClick={() => props.callback(false)}>
